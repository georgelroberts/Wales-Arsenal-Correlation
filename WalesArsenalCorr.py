...
walesData = walesData[walesData['Date'].dt.year >= 2016]
...
walesData['weekHash'] = dateTimetoWeekend(walesData['Date'], 2016)
...
arsenalData = arsenalData[arsenalData['date'].dt.year >= 2016]
...
arsenalData['weekHash'] = dateTimetoWeekend(arsenalData['Date'], 2016)
